...
export const NewsFeed = ({posts, handleNewsFeedEntryTitleClick}) => {
  const newsFeedEntries = posts.map((post) =>
    <NewsFeedEntry
      key={}
      post={post}
      handleNewsFeedEntryTitleClick={handleNewsFeedEntryTitleClick}
    />
  );
